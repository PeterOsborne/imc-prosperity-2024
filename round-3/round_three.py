...
class Trader:
    ...
    def run(self, state: TradingState):
        self.save_length = 70 # how many past records we save in traderData
        self.windows = (60, 3) # (the actual amount of data we look at for sd comparison, the point we are getting sd of (average over a few))
        self.pair_freq = 5  # period for which we run orders
